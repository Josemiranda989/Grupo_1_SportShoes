...
up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Products", [
      ...
      {
        id: 4,
        productName: "Adidas-Superstan",
        brand: "Adidas",
        description: "Features an iconic full-grain leather upper.",
        price: 172,
        size: 8,
        category: "Women´s",
        img: "1.png",
      ...
      {
        id: 11,
        productName: "Newbalance-327white",
        brand: "New Balance",
        description:
          "Features a mix of 1970s aesthetics and modern logo graphics.",
        price: 150,
      ...
      {
        id: 13,
        productName: "Newbalance-Wnl 327",
        brand: "New Balance",
        description:
          "Features a mix of 1970s aesthetics and modern logo graphics.",
        price: 160,
      ...
      },
      {
        ...
        brand: "Nike",
        description: "Leather upper for a comfortable fit and premium look",
        price: 160,
        size: 9,
        category: "Men´s",
        img: "1.png",
      ...
      {
        id: 23,
        productName: "Vans Old Skool Spongebob",
        brand: "Vans",
        description:
