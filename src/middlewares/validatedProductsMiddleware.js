...
module.exports = [
  ...
  body("color").notEmpty().withMessage("please write a color"),
  body("brand").notEmpty().withMessage("please write a brand"),
  body("size").notEmpty().withMessage("please write a size"),
